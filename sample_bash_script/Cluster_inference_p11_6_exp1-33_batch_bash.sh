...
#PBS -N ffn-inference-Longterm-Mov-p11_6-exp1-33-array
...
export logfile_name="inference_p11_6_exp1-33_batch_${PBS_ARRAYID}.log"
...
model_checkpoint_path: "/scratch/binxu.wang/ffn-Data/models/LR_model_Longtime_SF_Deep/model.ckpt-15005144"
model_name: "convstack_3d.ConvStack3DFFNModel"
model_args: "{\"depth\": 12, \"fov_size\": [33, 33, 17], \"deltas\": [8, 8, 4]}"
segmentation_output_dir: "/scratch/binxu.wang/results/LGN/p11_6_exp1-33"
inference_options {

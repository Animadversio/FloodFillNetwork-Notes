...
_DECORATEDVOLUME = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='npz', full_name='ffn.DecoratedVolume.npz', index=2,
...
_DECORATEDVOLUME.oneofs_by_name['volume_path'].fields.append(
  _DECORATEDVOLUME.fields_by_name['npz'])
_DECORATEDVOLUME.fields_by_name['npz'].containing_oneof = _DECORATEDVOLUME.oneofs_by_name['volume_path']

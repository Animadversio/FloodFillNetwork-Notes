...
#%%
ResultPath = "/home/morganlab/Downloads/ffn-master/results/LGN/testing_LR/0/0/" #"/Users/binxu/Connectomics_Code/results/LGN/testing_LR/0/0/"
...
for i in range(len(pair_cnts_sym)): # range(5000,5500):  #
    ...
    if not len(com_vec) == 0:
        ...
        seed_dict[(cur_idx1, cur_idx2)] = seed_dict.get((cur_idx1, cur_idx2), []) + com_vec
